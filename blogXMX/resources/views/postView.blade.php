                    ...
                    @foreach ($post->comments as $comment)
                        <div class="card mb-3 p-3 shadow-sm border-0">
                            <div class="d-flex">
                                <!-- Avatar -->
                                <div class="me-3">
                                    <img src="{{ isset($comment->user->image) ? asset('storage/' . $comment->user->image) : asset('storage/user.png') }}"
                                        alt="Foto do usuário" class="rounded-circle"
                                ...
                                <div class="flex-grow-1">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <a href="#" class="fw-bold text-decoration-none text-dark">
                                            {{ isset($comment->user->firstName) && isset($comment->user->lastName)
